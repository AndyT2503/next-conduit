...
export default function SettingForm() {
    const { register, handleSubmit, setValue } = useForm<UpdateCurrentUserBodyRequest>();
    const router = useRouter();
    const { isAuthenticated, status, errorResponse, user } = useSelector<RootState, AuthState>(
        (s) => s.auth
    );
